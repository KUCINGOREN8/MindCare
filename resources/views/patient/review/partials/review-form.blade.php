    ...
    <form action="{{ $action }}" method="POST" class="review-form">
        ...
        <div class="mb-8">
            ...
            <textarea 
                ...
                placeholder="What did you like about the session? Is there anything that could be improved?"
                maxlength="1000"
            >{{ $currentReviewText }}</textarea>
            <div class="flex justify-between mt-1">
                <p class="text-xs text-gray-500">Your review will be visible to the psychologist.</p>
