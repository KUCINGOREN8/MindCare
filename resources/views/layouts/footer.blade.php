<div class="bg-[#1F2937] flex flex-col items-center">
    <div class="flex m-10 justify-between">
        ...
        <div class="m-5 w-1/6">
            ...
            <div class="pt-3">
                <p class="text-[#9CA3AF] justify-center items-center text-justify">Supporting mental wellness with
        ...
        {{-- Support --}}
        <div class="m-5 w-1/6">
            <h3 class="text-white font-semibold text-lg">Support</h3>
            <p class="text-[#9CA3AF] font-semibold pt-2">Help Center</p>
            <p class="text-[#9CA3AF] font-semibold">Privacy Policy</p>
            <p class="text-[#9CA3AF] font-semibold">Terms of Service</p>
            <p class="text-[#9CA3AF] font-semibold">About Us</p>
        </div>
        ...
        <div class="m-5 w-1/6">
            ...
            <div class="pt-1 flex items-center space-x-2">
                ...
                <p class="text-[#9CA3AF] font-semibold">Available for 24/7</p>
            </div>
        </div>
    </div>
    <div>
        <div class="fixed-bottom text-center pb-10">
            <h5 class="text-[#9CA3AF]">© 2025 Be Okay. All rights reserved.</h5>
        </div>
    </div>
</div>
