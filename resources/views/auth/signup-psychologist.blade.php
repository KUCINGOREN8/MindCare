    ...
    <div class="flex" style="min-height: 100vh;">
        ...
        <div class="w-full lg:w-[70%] flex items-center justify-center bg-white overflow-y-auto px-6 md:px-12 py-16">
            <div class="w-full max-w-lg">
                ...
                <form class="space-y-6" action="{{ route('register.psychologist') }}" method="POST"
                    ...
                    <div>
                        <div class="flex items-center rounded-lg px-4 py-3 shadow-sm bg-[#FAFAFA]">
                            ...
                            <input type="text" name="specialization"
                                placeholder="Specialization (Clinical, Child, etc.)"
                                class="w-full bg-transparent outline-none text-black placeholder-gray-400"
                    ...
                    <div>
                        <div class="flex items-center rounded-lg px-4 py-3 shadow-sm bg-[#FAFAFA]">
                            ...
                            <input type="number" step="1000" name="consultation_fee"
                                placeholder="Consultation Fee (e.g., 200000)"
                                class="w-full bg-transparent outline-none text-black placeholder-gray-400"
                    ...
                    {{-- LANGUAGES CHECKBOX --}}
                    <div class="px-4 py-3">
                        <label class="block text-sm font-medium text-gray-700 mb-2">Languages Spoken (for
                            consultation)</label>
                        <div class="flex gap-4">
                            <label class="inline-flex items-center">
                                <input type="checkbox" name="languages[]" value="en" class="form-checkbox"
                                    {{ in_array('en', old('languages', [])) ? 'checked' : '' }}
                            ...
                            <label class="inline-flex items-center">
                                <input type="checkbox" name="languages[]" value="id" class="form-checkbox"
                                    {{ in_array('id', old('languages', [])) ? 'checked' : '' }}
                                    style="accent-color:#009C8F;">
                    ...
                    <div class="pt-3">
                        <button
                            class="w-full bg-[#009C8F] text-white py-3 rounded-lg font-medium hover:opacity-90 transition text-base shadow-md">
                            Sign Up
                        </button>
                    </div>
