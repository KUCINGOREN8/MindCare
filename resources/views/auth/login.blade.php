    ...
    <div class="flex" style="height: 100vh;">
        ...
        <div class="w-full lg:w-[70%] flex items-center justify-center bg-white overflow-y-auto"
            ...
            <div class="w-full max-w-lg">
                <h2 class="text-5xl font-bold mb-8 text-center" style="color: #009C8F;">{{ __('messages.login') }}</h2>
                ...
                <form class="space-y-6" method="POST" action="{{ route('login.post') }}">
                    ...
                    <div class="text-right">
                        <a href="{{ route('password.request') }}" class="text-sm font-medium underline"
                            style="color: #009C8F;">{{ __('messages.forgotpass') }}</a>
                    </div>

                    <div class="text-center pt-3">
                        <p class="text-gray-600 text-sm">
                            {{ __('messages.alreadyhaveaccount') }}
                            <a href="{{ route('signup') }}" class="font-medium underline"
                                style="color: #009C8F;">{{ __('messages.signup') }}</a>
                            {{ __('messages.here') }}.
                        </p>
                    </div>
                </form>
