        ...
        <div class="bg-white rounded-xl shadow-lg p-8">
            ...
            <form method="POST" action="{{ route('psychologist.signup.storeStep2', $user) }}">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="flex items-center rounded-lg px-4 py-3 shadow-sm" style="background-color: #FAFAFA;">
                            ...
                            <input type="text" name="title" required class="w-full outline-none text-black bg-transparent" placeholder="Clinical Psychologist" value="{{ old('title', $psychologist->title ?? '') }}">
                        </div>
                    ...
                    <div>
                        ...
                        <div class="flex items-center rounded-lg px-4 py-3 shadow-sm" style="background-color: #FAFAFA;">
                            ...
                            <input type="text" name="specialization" required class="w-full outline-none text-black bg-transparent" placeholder="Anxiety, CBT, Relationship" value="{{ old('specialization', $psychologist->specialization ?? '') }}">
                        </div>
                    ...
                    <div>
                        ...
                        <div class="flex items-center rounded-lg px-4 py-3 shadow-sm" style="background-color: #FAFAFA;">
                            ...
                            <input type="text" name="license_number" required class="w-full outline-none text-black bg-transparent" placeholder="PSY-198432" value="{{ old('license_number', $psychologist->license_number ?? '') }}">
                        </div>
                    ...
                    <div>
                        ...
                        <div class="flex items-center rounded-lg px-4 py-3 shadow-sm" style="background-color: #FAFAFA;">
                            ...
                            <input type="number" name="years_experience" required min="0" class="w-full outline-none text-black bg-transparent" placeholder="0" value="{{ old('years_experience', $psychologist->years_experience ?? 0) }}">
                        </div>
                    ...
                    <div>
                        ...
                        <div class="flex items-center rounded-lg px-4 py-3 shadow-sm" style="background-color: #FAFAFA;">
                            ...
                            <input type="number" name="consultation_fee" required min="10000" step="10000" class="w-full outline-none text-black bg-transparent" placeholder="200000" value="{{ old('consultation_fee', $psychologist->consultation_fee ?? '') }}">
                    ...
                    <div class="col-span-2">
                        ...
                        <div class="rounded-lg px-4 py-3 shadow-sm" style="background-color: #FAFAFA;">
                            <textarea name="short_bio" required rows="3" class="w-full outline-none text-black bg-transparent resize-none" placeholder="Brief introduction about yourself and your approach..." maxlength="500">{{ old('short_bio', $psychologist->short_bio ?? '') }}</textarea>
                        </div>
                    ...
                    <div class="col-span-2">
                        ...
                        <div class="rounded-lg px-4 py-3 shadow-sm" style="background-color: #FAFAFA;">
                            <textarea name="about_me" required rows="4" class="w-full outline-none text-black bg-transparent resize-none" placeholder="Detailed description of your experience, approach, philosophy...">{{ old('about_me', $psychologist->about_me ?? '') }}</textarea>
                        </div>
                ...
                <div class="mt-8 flex justify-between">
                    <a href="javascript:history.back()" class="px-6 py-3 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition">
                        ← Back
                    </a>
