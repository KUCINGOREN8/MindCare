    ...
    <div class="min-h-screen bg-gray-50">
        ...
        <div class="max-w-4xl mx-auto px-4 py-8">
            <div class="bg-white rounded-xl shadow-lg p-8">
                <h2 class="text-3xl font-bold text-center mb-2" style="color: #009C8F;">{{ __('messages.education') }}</h2>
                <p class="text-gray-600 text-center mb-8">Step 3: {{ __('messages.educationdesc') }}</p>
                ...
                <form method="POST" action="{{ route('psychologist.signup.storeStep3', $user) }}" id="educationForm">
                    ...
                    <div id="educationContainer">
                        <div class="education-entry bg-gray-50 p-6 rounded-lg mb-4 border border-gray-200 relative">
                            <button type="button"
                                class="remove-education-btn absolute -top-2 -right-2 bg-red-500 text-white rounded-full w-6 h-6 flex items-center justify-center shadow-md hover:bg-red-600 z-10 transition-colors"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div>
                                    <label class="block text-gray-700 mb-2">{{ __('messages.degree') }} <span
                                ...
                                <div>
                                    <label class="block text-gray-700 mb-2">{{ __('messages.institution') }} <span
                                            class="text-red-500">*</span></label>
                            ...
                            @if ($index > 0)
                                <div class="education-entry bg-gray-50 p-6 rounded-lg mb-4 border border-gray-200 relative">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                        ...
                                        <div>
                                            <label class="block text-gray-700 mb-2">{{ __('messages.year') }} <span
                                                    class="text-red-500">*</span></label>
