    ...
    <div class="min-h-screen bg-gray-50">
        ...
        <div class="max-w-4xl mx-auto px-4 py-8">
            <div class="bg-white rounded-xl shadow-lg p-8">
                <h2 class="text-3xl font-bold text-center mb-2" style="color: #009C8F;">{{ __('messages.experience') }}</h2>
                <p class="text-gray-600 text-center mb-8">Step 4: {{ __('messages.experiencedesc') }}</p>
                ...
                <form method="POST" action="{{ route('psychologist.signup.storeStep4', $user) }}" id="experienceForm">
                    ...
                    <div id="experienceContainer">
                        <div class="experience-entry bg-gray-50 p-6 rounded-lg mb-4 border border-gray-200 relative">
                            <button type="button"
                                class="remove-experience-btn absolute -top-2 -right-2 bg-red-500 text-white rounded-full w-6 h-6 flex items-center justify-center shadow-md hover:bg-red-600 z-10 transition-colors"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                <div>
                                    <label class="block text-gray-700 mb-2">{{ __('messages.position') }} <span
                                ...
                                <div>
                                    <label class="block text-gray-700 mb-2">{{ __('messages.organization') }} <span
                                            class="text-red-500">*</span></label>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label class="block text-gray-700 mb-2">{{ __('messages.startyear') }} <span
                                            class="text-red-500">*</span></label>
                                ...
                                <div>
                                    <label class="block text-gray-700 mb-2">{{ __('messages.endyear') }}</label>
                        ...
                        @foreach ($experiences as $index => $experience)
                            @if ($index > 0)
                                <div
                                    class="experience-entry bg-gray-50 p-6 rounded-lg mb-4 border border-gray-200 relative">
                                    <button type="button"
                                        class="remove-experience-btn absolute -top-2 -right-2 bg-red-500 text-white rounded-full w-6 h-6 flex items-center justify-center shadow-md hover:bg-red-600 z-10 transition-colors">
                                        <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="mb-8">
                        <button type="button" id="addExperienceBtn"
                            class="flex items-center text-[#009C8F] hover:opacity-80">
