    ...
    <div class="flex" style="height: 100vh;">
        ...
        <div class="w-full lg:w-[70%] flex items-center justify-center bg-white overflow-y-auto"
            ...
            <div class="w-full max-w-lg">
                <h2 class="text-5xl font-bold mb-2 text-center" style="color: #009C8F;">{{ __('messages.forgotpass') }}</h2>
                <p class="text-gray-600 text-center mb-8">{{ __('messages.enteremail') }}</p>
