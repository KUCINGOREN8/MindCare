                ...
                @forelse($history ?? [] as $item)
                    <div
                        ...
                        <div class="flex items-center gap-4">
                            <div
                                class="w-10 h-10 rounded-full bg-green-50 flex items-center justify-center text-green-500 group-hover:bg-green-500 group-hover:text-white transition">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500">
                                    {{ isset($item->date) ? \Carbon\Carbon::parse($item->date)->format('d F Y') : '-' }}</p>
                            </div>
                        </div>
                        <span
                            class="px-3 py-1 rounded-full text-[10px] font-bold bg-green-100 text-green-700 uppercase tracking-wide">Completed</span>
                    </div>
                @empty
