        ...
        <div class="flex flex-col gap-6">
            <div class="flex bg-white p-6 rounded-md border-grey-border border justify-between">
                <div class="flex flex-col">
                    ...
                    <h5 class="text-captiondark text-sm">{{ $subtitle }}</h5>
                </div>
                <button onclick="window.history.back()" type="submit" class="px-4 py-2 bg-[#00C3B3] hover:bg-[#179990] text-white rounded-md">Back</button>            </div>
            </div>
                ...
                <div class="mt-3">
                    ...
                    <div class="flex flex-1 h-[1px] mt-5 mb-5 bg-[#ECECEC]"></div>
                        <form id="profileForm" method="POST" action="{{ route('profile.update') }}" class="space-y-6">
                            ...
                            @method('PUT')
                            <div class="grid grid-cols-[20%_80%]">
                                <label class="block text-sm text-[#4D4D4E]">Full Name</label>
                            ...
                            <div class="grid grid-cols-[20%_80%]">
                                <label class="block text-sm text-[#4D4D4E]">Email Address</label>
                            ...
                            <div class="grid grid-cols-[20%_80%]">
                                <label class="block text-sm text-[#4D4D4E]">Date of Birth</label>
                                <div class="flex items-center rounded-lg px-4 py-3 shadow-sm" style="background-color: #FAFAFA;">
                                    <input 
                                        type="date" 
                                        name="date_of_birth" 
                            ...
                            <div class="grid grid-cols-[20%_80%]">
                                <label class="block text-sm text-[#4D4D4E]">Gender</label>
                                <div class="flex items-center rounded-lg px-4 py-3 shadow-sm" style="background-color: #FAFAFA;">
                                    <select 
                                        name="gender" 
                                        id="genderSelect"
                    ...
                    @if ($tab === 'privacy')
                        <div>
                            <p class="text-base-content/80">
                                Manage your <span class="font-semibold">Privacy</span> settings here.
                            </p>
                        </div>
                    @endif
                    ...
                    @if ($tab === 'preferences')
                        <div>
                            <p class="text-base-content/80">
                                <span class="font-semibold">Preferences:</span> Manage your display and notification settings.
                            </p>
                        </div>
                    @endif
