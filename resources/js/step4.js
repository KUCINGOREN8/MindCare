document.addEventListener("DOMContentLoaded", function () {
    ...
    function addExperienceField() {
        ...
        newEntry.className =
            "experience-entry bg-gray-50 p-4 md:p-6 rounded-lg mb-4 border border-gray-200 relative mt-4";
        newEntry.innerHTML = `
            <button type="button" class="remove-experience-btn absolute -top-3 -right-3 md:-top-2 md:-right-2 bg-red-500 text-white rounded-full w-8 h-8 md:w-6 md:h-6 flex items-center justify-center shadow-md hover:bg-red-600 z-10 transition-colors">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div>
                    <label class="block text-gray-700 mb-2 text-sm md:text-base">Position <span class="text-red-500">*</span></label>
                ...
                <div>
                    <label class="block text-gray-700 mb-2 text-sm md:text-base">Organization <span class="text-red-500">*</span></label>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <label class="block text-gray-700 mb-2 text-sm md:text-base">Start Year <span class="text-red-500">*</span></label>
                    <input type="text" name="experiences[${newIndex}][start_year]" required maxlength="4"
                           class="w-full outline-none text-black bg-white px-4 py-3 rounded-lg border border-gray-300 text-sm md:text-base"
                           placeholder="2023">
                </div>
                <div>
                    <label class="block text-gray-700 mb-2 text-sm md:text-base">End Year</label>
